...
[![Codecov test
coverage](https://codecov.io/gh/fastverse/kit/branch/master/graph/badge.svg)](https://app.codecov.io/gh/fastverse/kit?branch=master)
...
- **`fpmin`, `fpmax`, `prange`**: (Fast) parallel minimum, maximum, and
  range
